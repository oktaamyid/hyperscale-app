...
<section class="py-20 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <ul class="space-y-3 text-lg text-gray-600">
            <li class="flex items-start">
              <i class="fas fa-check-circle text-primary-500 mt-1 mr-3" aria-hidden="true"></i>
      ...
      <div use:animateOnScroll>
        <div class="relative">
          <div class="bg-gradient-to-br from-primary-500 to-purple-600 rounded-2xl p-8 shadow-xl">
...
<section class="py-20 bg-gradient-to-br from-gray-50 via-primary-50/30 to-purple-50/30 relative overflow-hidden">
  <div class="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-primary-100/20 to-transparent"></div>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      {#each [
        ...
        <div class="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100" use:animateOnScroll>
          <div class="relative">
            <div class="w-16 h-16 bg-gradient-to-br from-primary-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6 transform group-hover:rotate-6 transition-transform duration-300">
              <i class={`${value.icon} text-white text-2xl`} aria-hidden="true"></i>
            </div>
...
<section class="py-20 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative border-l-2 border-primary-100 pl-8 space-y-12" use:animateOnScroll>
      {#each [
        {
          year: '2020',
          title: 'Diluncurkan ke Publik',
          description:
            'HyperScale resmi diluncurkan sebagai platform PaaS lokal pertama dengan fokus pada developer experience.'
        },
        {
          year: '2021',
          title: 'Pertumbuhan Pengguna',
          description: 'Mencapai 10.000+ deployment dan meluncurkan fitur auto scaling serta observability terpadu.'
        },
        {
          year: '2022',
          title: 'Ekspansi Enterprise',
          description: 'Bermitra dengan berbagai perusahaan enterprise untuk modernisasi aplikasi dan migrasi cloud.'
        },
        {
          year: '2023',
          title: 'Platform AI Ready',
          description: 'Menambahkan layanan managed AI workloads dan integrasi edge computing untuk performa lebih tinggi.'
        }
      ] as milestone}
  ...
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" use:animateOnScroll>
    <div class="relative bg-white rounded-3xl shadow-2xl p-10 md:p-16 border border-primary-100">
      ...
      <div class="relative text-center">
        ...
        <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Mari Bangun Masa Depan Cloud Indonesia</h2>
