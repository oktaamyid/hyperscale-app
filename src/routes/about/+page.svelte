  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
    <div class="text-center mb-16" use:animateOnScroll>
      <div class="flex justify-center space-x-4 mb-8">
        <div
          class="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center animate-float"
        >
          <i class="fas fa-users text-white text-xl" aria-hidden="true"></i>
        </div>
        <div
          class="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center animate-float animation-delay-2000"
        >
          <i class="fas fa-rocket text-white text-xl" aria-hidden="true"></i>
        </div>
        <div
          class="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center animate-float animation-delay-4000"
        >
          <i class="fas fa-lightbulb text-white text-xl" aria-hidden="true"></i>
        </div>
      </div>
      ...
      >
        Kami adalah tim yang berdedikasi menghadirkan solusi Platform as a
        Service terbaik, membantu developer dan perusahaan mencapai potensi
        maksimal mereka.
      </p>
    </div>
  </div>
    ...
    <div class="grid lg:grid-cols-2 gap-16 items-center">
      <div use:animateOnScroll>
        ...
        <div class="mb-12">
          ...
          <p class="text-lg text-gray-600 leading-relaxed">
            Menjadi platform cloud terdepan di Asia Tenggara yang memberdayakan
            developer dan perusahaan untuk menciptakan inovasi teknologi yang
            mengubah dunia.
          </p>
        </div>
        <div>
          ...
          <ul class="space-y-3 text-lg text-gray-600">
            <li class="flex items-start">
              <i
                class="fas fa-check-circle text-primary-500 mt-1 mr-3"
                aria-hidden="true"
              ></i>
      ...
      <div use:animateOnScroll>
        <div class="relative">
          ...
          >
            <div class="grid grid-cols-2 gap-6 text-white">
              <div class="text-center">
                <div class="text-3xl font-bold mb-2">2020</div>
                <div class="text-sm opacity-90">Tahun Didirikan</div>
              </div>
              <div class="text-center">
          ...
          <div
            class="absolute -bottom-8 -right-8 w-32 h-32 bg-primary-200 rounded-full blur-3xl opacity-60"
          ></div>
        </div>
      </div>
    </div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
    <div class="text-center mb-16" use:animateOnScroll>
      ...
      <p class="text-xl text-gray-600 max-w-3xl mx-auto">
        Nilai-nilai ini memandu setiap keputusan dan tindakan kami dalam
        memberikan layanan terbaik.
      </p>
    </div>

    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      {#each [{ icon: "fas fa-lightbulb", title: "Inovasi", description: "Kami selalu mencari cara baru untuk meningkatkan platform dan memberikan nilai lebih kepada pengguna." }, { icon: "fas fa-users", title: "Kolaborasi", description: "Kami percaya kerjasama tim dan partnership yang kuat adalah kunci kesuksesan bersama." }, { icon: "fas fa-star", title: "Excellence", description: "Kami berkomitmen memberikan kualitas terbaik dalam setiap aspek layanan dan produk." }, { icon: "fas fa-heart", title: "Customer First", description: "Kami menempatkan kebutuhan pelanggan sebagai prioritas utama dalam setiap keputusan." }] as value}
        <div
        ...
        >
          <div class="relative">
            ...
            <div
              class="absolute top-0 left-1/2 -translate-x-1/2 w-16 h-16 bg-primary-500 rounded-2xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity"
            ></div>
          </div>
...
<section class="py-20 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16" use:animateOnScroll>
      ...
      <p class="text-xl text-gray-600 max-w-3xl mx-auto">
        Kami terus berkembang untuk memberikan teknologi terbaik bagi para
        developer dan bisnis di seluruh Indonesia.
      </p>
    </div>

    <div
      class="relative border-l-2 border-primary-100 pl-8 space-y-12"
      use:animateOnScroll
    >
      {#each [{ year: "2020", title: "Diluncurkan ke Publik", description: "HyperScale resmi diluncurkan sebagai platform PaaS lokal pertama dengan fokus pada developer experience." }, { year: "2021", title: "Pertumbuhan Pengguna", description: "Mencapai 10.000+ deployment dan meluncurkan fitur auto scaling serta observability terpadu." }, { year: "2022", title: "Ekspansi Enterprise", description: "Bermitra dengan berbagai perusahaan enterprise untuk modernisasi aplikasi dan migrasi cloud." }, { year: "2023", title: "Platform AI Ready", description: "Menambahkan layanan managed AI workloads dan integrasi edge computing untuk performa lebih tinggi." }] as milestone}
        <div class="relative pl-8">
          <div
            class="absolute -left-10 top-1 w-6 h-6 bg-primary-500 border-4 border-white rounded-full shadow-lg"
          ></div>
          <div
            class="absolute -left-12 top-1 w-12 h-12 bg-primary-500/10 rounded-full"
          ></div>
          <span
            class="inline-flex items-center px-4 py-1 bg-primary-50 text-primary-600 rounded-full font-semibold text-sm mb-3"
          >
            {milestone.year}
          </span>
...
>
  ...
  >
    <div
      class="relative bg-white rounded-3xl shadow-2xl p-10 md:p-16 border border-primary-100"
    >
      <div class="absolute inset-0 bg-grid-white opacity-10 rounded-3xl"></div>
      <div class="relative text-center">
        <div
          class="inline-flex items-center space-x-2 bg-primary-100 text-primary-600 px-6 py-2 rounded-full font-semibold mb-6"
        >
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto mb-10">
          Kami siap membantu Anda merancang, membangun, dan mengoperasikan
          aplikasi modern dengan performa tinggi. Hubungi kami untuk berdiskusi
          lebih lanjut.
        </p>
